...
> 일반 사용자의 경우 [dashboard for rinkeby](https://dashboard.tokamak.network)를 사용한다.
> For common users, we recommend using [dashboard for rinkeby](https://dashboard.tokamak.network?network=rinkeby).
